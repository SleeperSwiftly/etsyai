...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>EtsyDesc AI — Etsy Descriptions That Sell</title>
      ...
      <div className="page">
        ...
        <header className="header">
          <div className="logo">✦ EtsyDesc AI</div>
        ...
        <footer className="footer">
          <p>© 2025 EtsyDesc AI · Built for Etsy sellers who'd rather be making things.</p>
        </footer>
      </div>
      ...
      <style jsx>{`
        ...
        .upgrade-card {
          background: linear-gradient(135deg, #1e1a0e, #2a2010);
          border: 1px solid #e8c07d33;
          border-radius: 20px;
          padding: 40px;
          text-align: center;
        }
